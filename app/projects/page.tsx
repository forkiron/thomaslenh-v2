...
import daysyncImage from "@/app/assets/daysync.jpg";
...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "IoT system using an HC-SR04 sensor to track and visualize regional garbage levels. Includes a dashboard for real-time tracking using InfluxDB.",
    links: {
  ...
  {
    name: "DaySync",
    image: daysyncImage.src,
    badges: ["ClockHacks winner"],
    description:
      "Research-driven smart lighting productivity platform that dynamically adapts to users' cognitive states. Synchronizes with their smart devices and adjusts light intensity and temperature according to time-series dashboard. ",
    links: {
      code: "https://github.com/forkiron/DaySync",
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            {project.badges.map((badge, idx) => {
              const isWinner = badge.toLowerCase().includes("winner");
              return (
                <span
                  key={idx}
